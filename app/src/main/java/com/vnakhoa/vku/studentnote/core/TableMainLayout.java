...
public class TableMainLayout extends RelativeLayout {
    ...
    private void initComponents(){
        ...
        this.tableA.setBackgroundResource(R.color.table_bg);
        this.horizontalScrollViewB.setBackgroundResource(R.color.table_bg);
    ...
    TableRow componentATableRow(){
        ...
        TableRow.LayoutParams params = new TableRow.LayoutParams(Config.dpToPx(107,context),Config.dpToPx(70,context));
    ...
    private void generateTableC_AndTable_B(){
        ...
        for(SampleObject sampleObject : this.sampleObjects){
            ...
            tableRowForTableC.setBackgroundResource(R.color.table_bg);
            taleRowForTableD.setBackgroundResource(R.color.table_bg);
    ...
    TableRow tableRowForTableC(SampleObject sampleObject){
        ...
        textView.setPadding(10,Config.dpToPx(10,context),10,Config.dpToPx(10,context));
    ...
    TextView bodyTextView(String label){
        ...
        Typeface typeface = ResourcesCompat.getFont(context, R.font.signika_negative);
        bodyTextView.setTypeface(typeface,Typeface.BOLD);
        return bodyTextView;
    }
    ...
    TextView headerTextView(String label){
        ...
        Typeface typeface = ResourcesCompat.getFont(context, R.font.signika_negative);
        headerTextView.setTypeface(typeface,Typeface.BOLD);
